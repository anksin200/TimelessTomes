        ...
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='mb-4'>
                    ...
                    type="email" name='email' id='email' placeholder='Email' className='shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow' />
            ...
            <p className='algin-baseline font-medium mt-4 text-sm'>Don't have an account ? please <Link to='/register' className="text-blue-500 hover:text-blue-700">Register</Link></p>
